...
corporate_energy_consumption.Total_Consumption*277.78 AS NG_kWh, corporate_energy_consumption.Month, temperature_data.Monthly_Air_Temp,
...
WHERE corporate_energy_consumption.Energy_Description = 'Natural Gas' AND 
